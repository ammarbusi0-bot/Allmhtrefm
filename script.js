...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleCtaClick = (e) => {
        ...
        // منع السلوك الافتراضي للزر (التنقل) حتى يتم تنفيذ التشغيل والانتقال السلس
        e.preventDefault(); 
    };

    // ربط وظيفة التشغيل بزر CTA
    if (ctaButton) {
        // نستخدم نفس الدالة هنا أيضاً
        ctaButton.addEventListener('click', handleCtaClick); 
    }
    
    // ملاحظة: تم حذف جميع الأكواد القديمة المتعلقة بـ unmute أو audioControl.
...
// التنقل السلس (لروابط التنقل الأخرى)
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    // نتجنب زر CTA لأنه مرتبط بوظيفة تشغيل الصوت التي تتضمن التنقل
